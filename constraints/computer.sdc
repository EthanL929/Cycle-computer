...
# Created by write_sdc on Mon Apr 24 19:41:57 2023
...
set_input_delay -clock master_clock  -min 0.5  -network_latency_included  [get_ports nCrank]
set_input_delay -clock master_clock  -max 12  -network_latency_included  [get_ports nTrip]
set_input_delay -clock master_clock  -min 0.5  -network_latency_included  [get_ports nTrip]
set_input_delay -clock master_clock  -max 12  -network_latency_included  [get_ports nFork]
set_input_delay -clock master_clock  -min 0.5  -network_latency_included  [get_ports nFork]
set_output_delay -clock master_clock  -max 8  -network_latency_included  [get_ports {nDigit[3]}]
set_output_delay -clock master_clock  -min 0.5  -network_latency_included  [get_ports {nDigit[3]}]
set_output_delay -clock master_clock  -max 8  -network_latency_included  [get_ports {nDigit[2]}]
set_output_delay -clock master_clock  -min 0.5  -network_latency_included  [get_ports {nDigit[2]}]
set_output_delay -clock master_clock  -max 8  -network_latency_included  [get_ports {nDigit[1]}]
set_output_delay -clock master_clock  -min 0.5  -network_latency_included  [get_ports {nDigit[1]}]
set_output_delay -clock master_clock  -max 8  -network_latency_included  [get_ports {nDigit[0]}]
set_output_delay -clock master_clock  -min 0.5  -network_latency_included  [get_ports {nDigit[0]}]
set_output_delay -clock master_clock  -max 8  -network_latency_included  [get_ports SegF]
set_output_delay -clock master_clock  -min 0.5  -network_latency_included  [get_ports SegF]
set_output_delay -clock master_clock  -max 8  -network_latency_included  [get_ports DP]
set_output_delay -clock master_clock  -min 0.5  -network_latency_included  [get_ports DP]
set_output_delay -clock master_clock  -max 8  -network_latency_included  [get_ports SegC]
set_output_delay -clock master_clock  -min 0.5  -network_latency_included  [get_ports SegC]
set_output_delay -clock master_clock  -max 8  -network_latency_included  [get_ports SegE]
set_output_delay -clock master_clock  -min 0.5  -network_latency_included  [get_ports SegE]
set_output_delay -clock master_clock  -max 8  -network_latency_included  [get_ports SegD]
set_output_delay -clock master_clock  -min 0.5  -network_latency_included  [get_ports SegD]
set_output_delay -clock master_clock  -max 8  -network_latency_included  [get_ports SegA]
set_output_delay -clock master_clock  -min 0.5  -network_latency_included  [get_ports SegA]
...
set_output_delay -clock master_clock  -min 0.5  -network_latency_included  [get_ports SegB]
set_output_delay -clock master_clock  -max 8  -network_latency_included  [get_ports SegG]
set_output_delay -clock master_clock  -min 0.5  -network_latency_included  [get_ports SegG]
