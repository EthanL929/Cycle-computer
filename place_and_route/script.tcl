#easy script__do not care about the results of an individual operation and will carry on regardless of failures such as unresolved timing violations during the optimisation stages
...
# Save final design
    ...
    saveOaDesign Cycle_CPU_Verification computer layout
